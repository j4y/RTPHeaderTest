...
//  RTPHeaderTest
//
//  Created by Jay Prall on 11/24/15.
//  Copyright © 2015 Jay Prall. All rights reserved.
//
...
#define TEL_8000_PT         126 // Tel Audio Events
    ...
    public:
        ...
        inline RtpHeader() :
        cc(0), extension(0), padding(0), version(2), payloadtype(0), marker(0), seqnum(0), timestamp(0), ssrc(0), extensionpayload(0), extensionlength(0) {
